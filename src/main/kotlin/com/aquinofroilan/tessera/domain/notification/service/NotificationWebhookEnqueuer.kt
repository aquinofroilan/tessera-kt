...
class NotificationWebhookEnqueuer(
    ...
    fun enqueue(notification: Notification) {
        ...
        webhooks.filter { 
            ...
            val message = WebhookNotificationMessage(
            ...
            log.debug("Published webhook notification message to RabbitMQ for notification {} to webhook {}", notification.id, webhook.id)
        }
    }
}
