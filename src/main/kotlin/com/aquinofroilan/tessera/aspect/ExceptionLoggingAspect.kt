...
class ExceptionLoggingAspect {
    ...
    @AfterThrowing(pointcut = "execution(* com.aquinofroilan.tessera.service..*(..))", throwing = "exception")
    ...
    @AfterThrowing(pointcut = "execution(* com.aquinofroilan.tessera.controller..*(..))", throwing = "exception")
    ...
    @AfterThrowing(pointcut = "execution(* com.aquinofroilan.tessera.repository..*(..))", throwing = "exception")
