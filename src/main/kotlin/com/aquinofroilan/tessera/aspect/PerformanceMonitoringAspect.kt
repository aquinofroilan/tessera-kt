...
class PerformanceMonitoringAspect {
    ...
    @Around("execution(* com.aquinofroilan.tessera.service..*(..))")
    ...
    @Around("execution(* com.aquinofroilan.tessera.controller..*(..))")
    ...
    @Around("execution(* com.aquinofroilan.tessera.repository..*(..))")
