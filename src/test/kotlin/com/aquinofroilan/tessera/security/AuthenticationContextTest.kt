...
class AuthenticationContextTest {
    ...
    fun `organizationId should return id from SessionContext`() {
        ...
        auth.details =
            SessionContext(
                sessionId = java.util.UUID.fromString("40b076e7-51d5-3d27-b9de-9e4d4e428928"),
    ...
    fun `organizationId should return id from ApiKeyContext`() {
        ...
        auth.details =
            ApiKeyContext(
                apiKeyId = java.util.UUID.fromString("498a5a34-2265-3162-959e-3ac30559a1b3"),
                organizationId = java.util.UUID.fromString("8576b8f7-dd04-3e57-b849-081b3776f223"),
            )
        SecurityContextHolder.getContext().authentication = auth
