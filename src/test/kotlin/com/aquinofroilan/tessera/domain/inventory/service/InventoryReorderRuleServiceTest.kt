...
class InventoryReorderRuleServiceTest {
    ...
    fun `getRule enforces cross-org isolation`() {
        `when`(
            reorderRuleRepository.findById(java.util.UUID.fromString("b6a30083-eb9b-37f7-b5f3-39643f6fbc62")),
        ).thenReturn(Optional.of(rule(organizationId = otherOrgId)))
        assertThrows<ResourceNotFoundException> {
            service.getRule(
                java.util.UUID.fromString("b6a30083-eb9b-37f7-b5f3-39643f6fbc62"),
                orgId,
            )
        }
    }
    ...
    fun `updateRule applies partial changes`() {
        ...
        val result =
            service.updateRule(
                java.util.UUID.fromString("b6a30083-eb9b-37f7-b5f3-39643f6fbc62"),
                UpdateReorderRuleRequest(reorderPoint = BigDecimal("20")),
                orgId,
            )
    ...
    fun `lowStockReport returns only pairs below reorder point`() {
        `when`(reorderRuleRepository.findByOrganizationId(orgId)).thenReturn(
            listOf(
                rule(
                    id = java.util.UUID.fromString("b6a30083-eb9b-37f7-b5f3-39643f6fbc62"),
                    productId = java.util.UUID.fromString("c2cf5eda-4c7a-30a7-9e0b-be843869ca89"),
                ),
                rule(
                    id = java.util.UUID.fromString("a6458940-ef5f-365c-b738-9572bb4253e0"),
                    productId = java.util.UUID.fromString("85439c0c-f7b0-3e68-92c0-6195141662c1"),
                ),
                rule(
                    id = java.util.UUID.fromString("f26b40bb-3a45-34b7-9fb4-74e8b6576e9f"),
                    productId = java.util.UUID.fromString("a4bd2b8b-0864-3a85-b209-0cabb1f6f16a"),
                ),
            ),
        )
        `when`(stockMovementRepository.onHandByProductWarehouse(orgId)).thenReturn(
            mapOf(
                ...
                OnHandKey(
                    ...
                    BigDecimal("12"), // above
                OnHandKey(
                    java.util.UUID.fromString("a4bd2b8b-0864-3a85-b209-0cabb1f6f16a"),
                    java.util.UUID.fromString("c91d2c12-b2b4-3634-a3bb-d0ff561af4ff"),
                ) to
                    BigDecimal("2"), // below
            ),
        ...
        assertThat(
            report.lines
                .first {
                    it.productId == java.util.UUID.fromString("c2cf5eda-4c7a-30a7-9e0b-be843869ca89")
                }.shortfall,
        ).isEqualByComparingTo("6")
        assertThat(
            report.lines
                .first {
                    it.productId == java.util.UUID.fromString("a4bd2b8b-0864-3a85-b209-0cabb1f6f16a")
                }.shortfall,
