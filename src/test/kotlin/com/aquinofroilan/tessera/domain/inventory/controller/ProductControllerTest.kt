...
class ProductControllerTest {
    ...
    fun `GET products should support category filter`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/products").param("category", "Hardware"))
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.length()").value(1))
    }
    ...
    fun `GET products should support isActive filter`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/products").param("isActive", "true"))
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.length()").value(1))
    }
    ...
    fun `GET products should support search filter`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/products").param("search", "WIDGET"))
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.length()").value(1))
    }
    ...
    fun `GET products by id should return 200`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/products/00000000-0000-0000-0000-000000000199"))
            .andExpect(status().isOk)
    ...
    fun `GET products by id should return 404 when not found`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/products/00000000-0000-0000-0000-000000000000"))
    ...
    fun `PATCH products should return 200 when updated`() {
        ...
        mockMvc
            .perform(
                patch("/api/v1/inventory/products/00000000-0000-0000-0000-000000000199")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    fun `DELETE products should return 200 when soft deleted`() {
        ...
        mockMvc
            .perform(delete("/api/v1/inventory/products/00000000-0000-0000-0000-000000000199"))
            .andExpect(status().isOk)
    }
