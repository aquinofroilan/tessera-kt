...
class WarehouseControllerTest {
    ...
    fun `GET warehouses should return 200 with list`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/warehouses"))
    ...
    fun `GET warehouses should support search filter`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/warehouses").param("search", "MAIN"))
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.length()").value(1))
    }
    ...
    fun `GET warehouse by id should return 200`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/warehouses/22a14436-99e0-5e9d-9396-3a670fc505c0"))
            .andExpect(status().isOk)
    ...
    fun `GET warehouse by id should return 404 when not found`() {
        ...
        mockMvc
            .perform(get("/api/v1/inventory/warehouses/00000000-0000-0000-0000-000000000000"))
    ...
    fun `PATCH warehouses should return 200 when updated`() {
        ...
        mockMvc
            .perform(
                patch("/api/v1/inventory/warehouses/22a14436-99e0-5e9d-9396-3a670fc505c0")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    fun `DELETE warehouses should return 200 when soft deleted`() {
        ...
        mockMvc
            .perform(delete("/api/v1/inventory/warehouses/22a14436-99e0-5e9d-9396-3a670fc505c0"))
            .andExpect(status().isOk)
    }
