...
class AccountControllerTest {
    ...
    fun `GET accounts should return 200 with account list`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/accounts"))
    ...
    fun `GET accounts by id should return 200`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/accounts/12a14436-99e0-5e9d-9396-3a670fc505c0"))
            .andExpect(status().isOk)
            .andExpect(jsonPath("$.id").value("12a14436-99e0-5e9d-9396-3a670fc505c0"))
            .andExpect(jsonPath("$.code").value("1000"))
            .andExpect(jsonPath("$.name").value("Cash"))
    ...
    fun `GET accounts by id should return 404 when not found`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/accounts/00000000-0000-0000-0000-000000000000"))
    ...
    fun `PUT accounts should return 200 when updated`() {
        ...
        mockMvc
            .perform(
                put("/api/v1/finance/accounts/12a14436-99e0-5e9d-9396-3a670fc505c0")
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    fun `DELETE accounts should return 200 when deactivated`() {
        mockMvc
            .perform(delete("/api/v1/finance/accounts/12a14436-99e0-5e9d-9396-3a670fc505c0"))
            .andExpect(status().isOk)
    ...
    fun `GET accounts should return 400 for invalid type query param`() {
        mockMvc
            .perform(get("/api/v1/finance/accounts").param("type", "INVALID"))
            .andExpect(status().isBadRequest)
