...
import com.aquinofroilan.tessera.domain.finance.model.PaymentRunLine
import com.aquinofroilan.tessera.domain.finance.model.PaymentRunLineStatus
import com.aquinofroilan.tessera.domain.finance.model.PaymentRunStatus
import com.aquinofroilan.tessera.domain.finance.repository.PaymentRunRepository
...
class PaymentRunServiceTest {
    ...
    private fun draftRun(status: PaymentRunStatus = PaymentRunStatus.DRAFT) =
        PaymentRun(
            ...
            lines =
                listOf(
                    com.aquinofroilan.tessera.domain.finance.model.PaymentRunLine(
                        lineNumber = 1,
    ...
    private fun payment() =
        BillPayment(
            ...
            exchangeRate = BigDecimal.ONE,
            paymentMethod = com.aquinofroilan.tessera.domain.finance.model.PaymentMethod.BANK_TRANSFER,
