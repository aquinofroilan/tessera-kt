...
import com.aquinofroilan.tessera.domain.finance.dto.ReportAccountLine
import com.aquinofroilan.tessera.domain.finance.dto.SyntheticAccountIds
...
class FinancialReportControllerTest {
    ...
    fun `GET trial-balance returns 200 with current and comparative blocks`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/reports/trial-balance?asOfDate=2026-03-31&compareAsOfDate=2026-02-28"))
    ...
    fun `GET income-statement returns 200 and required fields`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/reports/income-statement?startDate=2026-03-01&endDate=2026-03-31"))
            .andExpect(status().isOk)
    ...
    fun `GET income-statement returns 400 when required date is missing`() {
        mockMvc
            .perform(get("/api/v1/finance/reports/income-statement?startDate=2026-03-01"))
    ...
    fun `GET balance-sheet returns 200 with synthetic earnings line`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/reports/balance-sheet?asOfDate=2026-03-31"))
            .andExpect(status().isOk)
    ...
    fun `GET trial-balance returns 403 without journal read permission`() {
        ...
        mockMvc
            .perform(get("/api/v1/finance/reports/trial-balance"))
